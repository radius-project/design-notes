...
![diagram showing types-contrib repo structure that includes root directories for core and extended types](2025-06-compute-extensibility-feature-spec/types-contrib-repo-structure.png)
