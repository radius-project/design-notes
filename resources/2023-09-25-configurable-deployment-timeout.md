...
2. We could rely on the user to specify the readiness probe paramters. However, the disadvantage is that it will be a burden on the end users to specify these  parameters to ensure a successful deployment.
...
2. We could rely on the user to specify the readiness probe paramters.
...
2. Ensure that the asyncworker timeout is greater than the user specified timeout
